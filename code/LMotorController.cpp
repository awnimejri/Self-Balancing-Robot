...
void LMotorController::move(int leftSpeed, int rightSpeed, int minAbsSpeed)
{
    ...
    analogWrite(_enb, realLeftSpeed * _motorBConst);*/
     ...
     analogWrite(_in1,rightSpeed > 0 ?  realRightSpeed * _motorAConst : 0);
     analogWrite(_in2,rightSpeed > 0 ?  0:realRightSpeed * _motorAConst );
     analogWrite(_in3,leftSpeed > 0 ?  realLeftSpeed * _motorBConst : 0);
     analogWrite(_in4,leftSpeed > 0 ?  0 : realLeftSpeed * _motorBConst);
}
...
void LMotorController::move(int speed, int minAbsSpeed)
{
   ...
   analogWrite(_in1,speed > 0 ?  realSpeed * _motorAConst : 0);
   analogWrite(_in2,speed > 0 ?  0:realSpeed * _motorAConst );
   analogWrite(_in3,speed > 0 ?  realSpeed * _motorBConst : 0);
   analogWrite(_in4,speed > 0 ?  0 : realSpeed * _motorBConst);
}
